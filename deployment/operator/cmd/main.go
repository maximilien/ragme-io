...
func main() {
	...
	disableHTTP2 := func(c *server.Config) {
		setupLog.Info("disabling http/2")
		c.DisableHTTP2 = true
	}

	tlsOpts := []func(*webhook.Config){}
	if !enableHTTP2 {
		tlsOpts = append(tlsOpts, webhook.DisableHTTP2)
	}
	...
	if secureMetrics {
		...
		// More info:
		// https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.16.3/pkg/metrics/filters#WithAuthenticationAndAuthorization
		// metricsServerOptions.FilterProvider = filters.WithAuthenticationAndAuthorization
		metricsServerOptions.SecureServing = true
		// TODO: For more info about the authn/authz mechanism, see this page:
		// https://github.com/kubernetes-sigs/controller-runtime/blob/main/TMP-LOGGING.md
	} else {
		disableHTTP2(&metricsServerOptions)
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		//
		// In the default scaffold provided, the program ends immediately when

...
class WeaviateVectorDatabase(VectorDatabase):
    ...
    def create_query_agent(self, llm=None):
        ...
        # Use our custom QueryAgent instead of the built-in Weaviate QueryAgent
        # to ensure LLM-based detailed query detection works

        # Create a custom query agent that uses Weaviate for search but our logic for processing
        class WeaviateCustomQueryAgent:
            ...
            async def run(self, query: str, is_detailed: bool = None):
                ...
                try:
                    ...
                    documents = self.vector_db.search(query, limit=self.top_k)
        ...
        return WeaviateCustomQueryAgent(self, llm)

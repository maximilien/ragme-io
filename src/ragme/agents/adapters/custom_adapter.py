...
class CustomAdapter(AbstractAgent):
    ...
    def __init__(
        ...
        custom_agent_instance: Optional[Any] = None,
        **kwargs
    ):
    ...
    async def run(self, query: str, **kwargs) -> str:
        ...
        try:
            ...
            if hasattr(self.custom_agent, 'run') and callable(getattr(self.custom_agent, 'run')):
                # Try to call async version first
                if hasattr(self.custom_agent.run, '__code__') and 'await' in str(self.custom_agent.run.__code__.co_code):
            ...
            elif hasattr(self.custom_agent, 'process') and callable(getattr(self.custom_agent, 'process')):
                response = self.custom_agent.process(query, **kwargs)
                return str(response)
                
            elif hasattr(self.custom_agent, 'query') and callable(getattr(self.custom_agent, 'query')):

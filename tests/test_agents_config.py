...
class TestAgentsConfig:
    ...
    def test_get_agent_config_from_agents_file(self):
        ...
        agents_data = {
            "agents": [
                ...
                {"name": "other-agent", "role": "other", "type": "custom"},
            ]
        }
    ...
    def test_get_agent_config_fallback_to_inline(self):
        ...
        config_manager._config = {
            "agents": [
                {"name": "inline-agent", "type": "ragme", "llm_model": "gpt-4o-mini"}
            ]
        }
    ...
    def test_get_agents_directory(self):
        ...
        config_manager = ConfigManager()
        config_manager._agents_config = {"agents_directory": "/custom/agents/path"}

        agents_dir = config_manager.get_agents_directory()

        # Should return absolute path
        assert (
            agents_dir.endswith("custom/agents/path")
            or agents_dir == "/custom/agents/path"
        )
                ...
                "agents": [
                    {
                        ...
                        "env": {"api_key": "${OPENAI_API_KEY:-default-key}"},
                    }
                ]
            }
    ...
    def test_agents_yaml_parsing_error(self):
        ...
        with (
            ...
            with pytest.raises(ValueError, match="Error parsing agents configuration"):
                _ = config_manager.agents_config

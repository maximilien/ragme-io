...
class TestDocumentProcessor(unittest.TestCase):
    ...
    def test_is_supported_file(self):
        ...
        self.assertTrue(
            self.processor.is_supported_file("test.PDF")
        )  # Case insensitive
        ...
        self.assertFalse(
            self.processor.is_supported_file("test.doc")
        )  # Old Word format
    ...
    def test_chunk_text_long(self):
        ...
        for chunk in chunks:
            self.assertLessEqual(
                len(chunk), self.processor.chunk_size * 1.2
            )  # 20% tolerance
    ...
    def test_process_pdf_with_fallback_success(self, mock_fitz):
        ...
        try:
            text, page_count, metadata, extracted_images = (
                self.processor.process_pdf_with_fallback(temp_pdf_path)
            )
    ...
    def test_process_image_success(self, mock_image_processor):
        ...
        mock_processed_image = {
            ...
            "ocr_content": {"extracted_text": "Sample text", "ocr_processing": True},
        }
...
class TestDocumentProcessorIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch("src.ragme.data_processing.processor.config") as mock_config:
            ...
            mock_config.get_image_collection_name.return_value = (
                "test_integration_images"
            )

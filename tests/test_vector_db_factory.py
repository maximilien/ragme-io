...
class TestCreateVectorDatabase:
    ...
    def test_create_weaviate_database(self):
        ...
        with patch('src.ragme.vector_db_factory.WeaviateVectorDatabase') as mock_weaviate_db:
    ...
    def test_create_milvus_database(self):
        ...
        with patch('src.ragme.vector_db_factory.MilvusVectorDatabase') as mock_milvus_db:
            mock_instance = MagicMock()
